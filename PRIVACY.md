...
- Leaderboard requests explicitly omit TryHackMe cookies and authentication credentials.
...
- `scripting` runs the user-requested anonymous leaderboard call in the active TryHackMe tab when possible.
- Access to `https://tryhackme.com/*` is required to request public leaderboard data without cookies.
